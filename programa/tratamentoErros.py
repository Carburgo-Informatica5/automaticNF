...
class ErrosBravosConexao(ExcecaoNF):
    ...
    def __init__(self, mensagem: str, tentativas: int = 0, ultimo_erro: str = None):
        detalhes = {"tentativas_conexao": tentativas, "ultimo_erro": ultimo_erro}
